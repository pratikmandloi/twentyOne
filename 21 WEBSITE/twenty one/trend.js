...
function displayFirstSec(data) {
  ...
  data.map(function (el) {
    ...
    img.addEventListener("click", function () {
      window.location.href = `./product2.html?id=${el.id}`
    })
    let p = document.createElement("p")
    p.innerText = el.name
    p.addEventListener("click", function () {
      window.location.assign(`product2.html?id=${el.id}`)
...
// let baby = [{
//   img: "https://static.zara.net/photos///2022/I/0/3/p/6048/563/712/2/w/297/6048563712_6_1_1.jpg?ts=1652370563860",
...
// let baby2 = [{
//   img: "https://static.zara.net/photos///2022/I/0/3/p/0722/508/500/2/w/297/0722508500_6_1_1.jpg?ts=1653986212859",
//   name: "HENLEY T-SHIRT",
//   price: 590,
//   ProductID: "SHIRT"
// },
